...
- `specs/rules/po-rules.instructions.md` — operating rules, conventions, and anti-patterns
- `specs/hooks/po-hooks.instructions.md` — validation checklists to apply before delivering
