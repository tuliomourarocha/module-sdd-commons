...
- `.opencode/commands/po-prompt.md` — full system prompt, workflow, and quality gates
- `.opencode/commands/po-rules.md` — operating rules, conventions, and anti-patterns
- `.opencode/commands/po-hooks.md` — validation checklists to apply before delivering
