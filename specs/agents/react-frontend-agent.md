...
- `specs/prompts/react-frontend-prompt.md` — full system prompt, workflow, and quality gates
- `specs/instructions/react-frontend-rules.md` — operating rules, conventions, and anti-patterns
- `specs/hooks/react-frontend-hooks.md` — validation checklists to apply before delivering code
